...
- Forward model: `y = A x`, compression 0.1 (m = 1228, n = 12288). Matrix saved locally at `RESULTS/baselineA.npy` (Rademacher, seed 42, scaled by 1/sqrt(m)). Not tracked in git.
...
Notes:
- `RESULTS/` is ignored from git; keep `baselineA.npy`, `generaldenoiser.pth`, and the eval log there.
